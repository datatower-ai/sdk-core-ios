...
#import "DTWeakProxy.h"

@interface DTFPSMonitor () {
    CADisplayLink *_link;
    NSUInteger _count;
...
- (void)startDisplay {
    ...
    _link = [CADisplayLink displayLinkWithTarget:[DTWeakProxy proxyWithTarget:self] selector:@selector(tick:)];
